...
class CppNameMapNode : public NameMapNode {
    ...
    QString myFileName;
    bool isRoot = false;
    QString* myParentFileName = nullptr;
    bool refParentFileName = false;

public:
    explicit CppNameMapNode(QString name, const CodeNode* node);
    QString* getMyFileName();
    bool GetIsRoot();
    void setFile(QString myFileName);
    void setFile(QString* fileNameRef);
...
private:
    ...
    static void preOrderDFS_NameMapBuild(CppNameMapNode* parent, CodeNode* _this);
};